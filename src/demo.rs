...
pub fn demo_event(tick: u32) -> Option<DemoEvent> {
    ...
    match phase {
        ...
        // Rule firing
        4 => Some(DemoEvent {
            message: "Rule 'deny-rm-rf': denied ml-pipeline (Bash: rm -rf /tmp/cache)".into(),
        ...
        8 => Some(DemoEvent {
            message:
                "Health: ml-pipeline cognitive decay at 82/100 — session degrading, consider restart"
                    .into(),
        ...
        // Hive: personal pattern NOT shared
        30 => Some(DemoEvent {
